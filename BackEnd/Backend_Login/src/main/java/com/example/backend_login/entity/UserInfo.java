...
public class UserInfo {
    ...
    @Column(name = "campus")
    private Byte campus; // 新增校区属性，对应数据库中的tinyint类型

    @Column(name = "educational_background")
    private Integer educational_background; // 新增学历属性，对应数据库中的int类型
    ...
    @Column(name = "industry_options")
    private Integer industry_options; // 新增行业领域属性，对应数据库中的int类型
