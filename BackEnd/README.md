...
CREATE TABLE `userinfo` (
    ...
    `industry_options` int(11) DEFAULT NULL COMMENT '行业领域：存key',
    `profession` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '职业',
    `company` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '所在公司',
